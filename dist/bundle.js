...
/***/ (function(module, exports) {
	...
	var Item = function () {
	    function Item(name, price, chance) {
	...
	var Game = function () {
	    ...
	    _createClass(Game, [{
	        ...
	        value: function duplicateItems() {
	            ...
	            this._items = [].concat.apply([], Array.apply(null, new Array(this._rounds)).map(function () {
	                return _this._items;
	            }));
	        ...
	        key: 'selectWinner',
	        value: function selectWinner() {
	            var _this2 = this;

	            var itemsToSkip = this._originalItems.length * (this._rounds / 3);
